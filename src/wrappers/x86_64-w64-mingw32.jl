...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libgurobi,
        joinpath("gurob1300", "win64", "bin", "gurobi130.dll"),
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    JLLWrappers.@init_executable_product(gurobi_cl, joinpath("gurob1300", "win64", "bin", "gurobi_cl.exe"))
    JLLWrappers.@init_executable_product(grbgetkey, joinpath("gurob1300", "win64", "bin", "grbgetkey.exe"))
